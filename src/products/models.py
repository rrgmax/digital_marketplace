...
def product_post_save_receiver(sender, instance, created, *args, **kwargs):
    if instance.media:
        ...
        if hd_created:            
            ...
            hd.media.save(filename, thumb_file) # Could be a problem
        ...
        if sd_created:            
            ...
            thumb_file = File(thumb_data)
            sd.media.save(filename, thumb_file) # Could be a problem
        ...
        if micro_created:            
            ...
            thumb_file = File(thumb_data)
            micro.media.save(filename, thumb_file) # Could be a problem
